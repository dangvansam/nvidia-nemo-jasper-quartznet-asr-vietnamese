...
encoder_checkpoint = 'quartznet12x1_06012021_tts_meta_data/checkpoints/JasperEncoder-STEP-398000.pt'
decoder_checkpoint = 'quartznet12x1_06012021_tts_meta_data/checkpoints/JasperDecoderForCTC-STEP-398000.pt'
...
if __name__ == '__main__':
    socketio.run(app, host="192.168.2.26", port=4020, ssl_context="adhoc", debug=True)
    # socketio.run(app, host="192.168.2.26", certfile='cert.pem', keyfile='key.pem', port=4010)