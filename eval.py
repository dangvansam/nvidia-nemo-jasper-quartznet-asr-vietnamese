...
def main():
    ...
    parser.add_argument("--eval_datasets",default='data/wavenet_new_simple.json', type=str, required=False)
    parser.add_argument("--load_dir",default='QuartzNet12x1_all/checkpoints', type=str, required=False)
    # run params
    ...
    parser.add_argument("--lm_path", default='out_text_phoneme-lm.binary', type=str)
    parser.add_argument('--alpha', default=0.1, type=float, help='value of LM weight', required=False)
    parser.add_argument('--alpha_max',default=1.2, type=float,help='maximum value of LM weight (for a grid search in eval mode)',required=False,)
    parser.add_argument('--alpha_step', type=float, help='step for LM weights tuning in eval mode', required=False, default=0.1)
    parser.add_argument('--beta', default=1.2, type=float, help='value of word count weight', required=False)
    parser.add_argument('--beta_max',type=float,help='maximum value of word count weight (for a grid search in eval mode',required=False,)
    parser.add_argument('--beta_step',type=float,help='step for word count weights tuning in eval mode',required=False,default=0.1,)
